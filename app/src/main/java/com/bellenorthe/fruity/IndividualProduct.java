...
public class IndividualProduct extends AppCompatActivity {
    ...
    public void shareProduct(View view) {
        ...
        String shareBody = "Found amazing " + productname.getText().toString() + "on Fruity App";
    ...
    private SingleProductModel getProductObject() {
        ...
        return new SingleProductModel(model.getCardid(), Integer.parseInt(quantityProductPage.getText().toString()), useremail, usermobile, model.getCardname(), model.getCardprice(), model.getCardimage(), model.carddiscription, customheader.getText().toString(), custommessage.getText().toString());
    ...
    public void addToCart(View view) {
        ...
        if ( customheader.getText().toString().length() == 0 ||  custommessage.getText().toString().length() ==0 ){
            ...
            Snackbar.make(view, "Header or Message Empty", Snackbar.LENGTH_LONG).setAction("Action", null).show();
