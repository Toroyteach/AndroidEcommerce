...
import com.bellenorthe.fruity.networksync.ChangePhotoRequest;
import com.bellenorthe.fruity.networksync.CheckInternetConnection;
import com.bellenorthe.fruity.networksync.UpdateRequest;
...
public class UpdateData extends AppCompatActivity {
    ...
    private Button button, location;
    ...
    String changedImage;
    String token = "Acccount changed";

    //to get user session data
    private UserSession session;
    private HashMap<String,String> user;
    private String name,email,photo,mobile,newemail, uid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (validateName() && validateEmail() && validateNumber()) {
                    ...
                    UpdateRequest updateRequest = new UpdateRequest(name, mobile, email, uid, newemail, new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            ...
                            try {
                                if (new JSONObject(response).getBoolean("success")) {
                                    ...
                                    session.createLoginSession(uid,name,newemail,mobile,photo, token);
        ...
        //run the check validate for location addressing
        checkcndsetdeliverylocation();
    }

    public void checkcndsetdeliverylocation(){
        location=findViewById(R.id.deliverylocation);
